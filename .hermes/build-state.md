...
**Next: VoiceRecorder toast slice (complex browser-API, needs MediaRecorder mock) OR more accessibility (keyboard nav, contrast) OR more loading skeletons (onboarding, lesson approval).**
