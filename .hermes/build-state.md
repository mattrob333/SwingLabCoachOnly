...
**Focus-visible ring styles ✅ DONE (commit dded234):** 8 tests covering all raw `<button>` elements (error boundaries, top nav, inbox tabs, payment toggle, toaster dismiss). 972 tests total.

**Next: Wave 6 Task 5 continued (test coverage gaps) OR more accessibility polish (keyboard nav, contrast).** Interleave as needed.
